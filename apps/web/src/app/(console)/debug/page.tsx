...
export default function DebugPage() {
  ...
  const [asserts, setAsserts] = useState<AssertSpec[]>([
                    ...
                    {headers.map((h, i) => (
                      <div key={i} className="flex gap-2">
                        <Input
                          ...
                          onChange={(e) =>
                            setHeaders((hs) =>
                              hs.map((x, idx) => (idx === i ? { ...x, key: e.target.value } : x)),
                            )
                          }
                        />
                        <Input
                    ...
                    {asserts.map((a, i) => (
                      <div key={i} className="flex gap-2">
                        <Select
                          ...
                          onChange={(kind) =>
                            setAsserts((as) => as.map((x, idx) => (idx === i ? { ...x, kind } : x)))
                          }
                        />
                        <Input
                          ...
                          onChange={(e) =>
                            setAsserts((as) =>
                              as.map((x, idx) => (idx === i ? { ...x, path: e.target.value } : x)),
                            )
                          }
                        />
                        <Select
                          ...
                          onChange={(op) =>
                            setAsserts((as) => as.map((x, idx) => (idx === i ? { ...x, op } : x)))
                          }
                        />
                        <Input
                          className="flex-1 font-mono"
                        ...
                        <Button
                          ...
                          onClick={() => setAsserts((as) => as.filter((_, idx) => idx !== i))}
                        >
                          ✕
                        </Button>
                      </div>
