...
export const debugBodySchema = z.object({
...
export const frameBase = { taskId: z.string().uuid(), seq: z.number().int(), ts: z.number() } as const;
...
export const eventFrameSchema = z.discriminatedUnion('type', [
  taskStartFrame, stepStartFrame, stepResultFrame, logFrame, taskFinalFrame,
]);
