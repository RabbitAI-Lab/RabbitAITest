...
| --- | --- | --- | --- | --- | --- |
| M1 | W1-2 | [sprint-0-poc](./sprint-0-poc/sprint-overview.md) | POC 技术验证（P0） | 10 | 概览已确认，规格待产出 |
...
### Sprint 0 — POC（P0 · 10 份）
INFRA-001 monorepo 脚手架｜INFRA-002 docker-compose｜INFRA-003 数据模型基线｜SYS-001 注册登录｜SYS-002 路由守卫与隔离｜SYS-003 组织项目初始化｜CASE-001 用例 CRUD｜API-001 HTTP 调试｜EXEC-001 引擎内核 v0｜RPT-001 最小执行报告
