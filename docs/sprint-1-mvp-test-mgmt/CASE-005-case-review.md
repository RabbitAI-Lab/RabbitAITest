...
| 高保真确认   | 待确认（原型已产出 docs/design/CASE-005-case-review/，人工确认待 Sprint 验收走查——不可由 AI 代签，见 ai-collaboration §5）                                                                                                          |
...
- 勘误 1（2026-09-26）：ReviewCase.reviewers 与 CaseReview.created_by 列 S1 首迁移遗漏已补齐（「我创建的」视图与批量改评审人依赖）。
