...
| 高保真确认 | 待确认（原型已产出 docs/design/SYS-004-user-group-management/，人工确认待 Sprint 验收走查——不可由 AI 代签，见 ai-collaboration §5） |
...
## 8. 勘误登记
- 勘误 1（2026-09-26）：重复邮箱返回 400 code 10101（规格文字为 422）——保持与 SYS-001 既有契约一致，jmx 断言按 400。
